								...
								<tr class="table_row">
									...
									<td class="column-4">
										<div class="wrap-num-product flex-w m-l-auto m-r-0">
											...
											<input class="mtext-104 cl3 txt-center num-product" type="number" name="quantity" id="quantity_{{$crud->id}}" value="{{$crud->quantity}}">

											<div class="btn-num-product-up cl8 hov-btn3 trans-04 flex-c-m" onclick="UpdateQuantity({{ $crud->id }}, this, 'add')">
